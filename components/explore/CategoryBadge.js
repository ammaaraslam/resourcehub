...
const CategoryBadge = ({ category }) => {
  ...
  if (category === "Article") {
    return (
      <button
        ...
        className="py-1 px-3 rounded-md bg-purple-600 dark:bg-purple-500 text-white dark:text-black font-montserrat font-semibold inline-flex md:text-lg text-base"
      >
  ...
  if (category === "Developer Tool") {
    return (
      <button
        ...
        className="py-1 px-3 rounded-md bg-purple-600 dark:bg-purple-500 text-white dark:text-black font-montserrat font-semibold inline-flex "
      >
  ...
  if (category === "Online Platform") {
    return (
      <button
        ...
        className="py-1 px-1 rounded-md bg-purple-600 dark:bg-purple-500 text-white dark:text-black font-montserrat font-semibold inline-flex md:text-lg text-base"
      >
  ...
  if (category === "Open Source") {
    ...
    return (
      <button className="py-1 px-3 rounded-md bg-purple-600 dark:bg-purple-500 text-white dark:text-black font-montserrat font-semibold inline-flex md:text-lg text-base">
