...
export const ResourceCardSkeleton = () => {
  return (
    <article className="m-5 md:w-[22rem] md:h-[28rem] w-[19rem] h-[23rem] bg-white dark:bg-black border-2 border-gray-300 dark:border-gray-400 rounded-2xl md:py-7 md:px-4 py-4 px-2 relative transition-all duration-300">
