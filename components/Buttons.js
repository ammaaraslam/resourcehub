export const PrimaryButton = ({ children, handleOnClick }) => {
  return (
    <button
      type="button"
      className="group md:py-3 md:px-7 py-2 px-5 m-2 w-fit bg-purple-600 rounded-2xl inline-flex justify-center items-center transition-all duration-200 font-sf font-extrabold text-white dark:text-black md:text-2xl text-xl text-center hover:bg-purple-700"
